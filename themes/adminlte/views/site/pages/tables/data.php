<?php
$this->pageTitle='Data Tables - '.Yii::app()->name;
...
// DATA TABLES
$cs->registerCssFile($tcss.'datatables/dataTables.bootstrap.css');
...
// DATA TABES SCRIPT
$cs->registerScriptFile($tplugins.'datatables/jquery.dataTables.js', CClientScript::POS_END);
$cs->registerScriptFile($tplugins.'datatables/dataTables.bootstrap.js', CClientScript::POS_END);
...
// page script
Yii::app()->clientScript->registerScript('datatable-page', "
    $(function() {
        $(\"#example1\").dataTable();
        $('#example2').dataTable({
            \"bPaginate\": true,
